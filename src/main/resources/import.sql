...
insert into usuario (usuario, senha) values ('admin', '$2a$12$Gmcnb9zxhFjfPC3nM.1M0eYjw8716j/ifqOx0tZTp.Cm/5JWE9NPq');
...
INSERT INTO PESSOA_FISICA (ID, NOME, CPF, usuario_id) VALUES (1, 'João', '276.852.120-56', 2);
INSERT INTO PESSOA_JURIDICA (ID, NOME, CNPJ, usuario_id) VALUES (2, 'Maria', '42.618.444/0001-35', 3);
