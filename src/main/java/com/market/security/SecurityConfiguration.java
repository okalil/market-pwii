...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests((auth) -> {
            try {
                auth
                        .requestMatchers("/pf", "/pj", "/produtos").hasAuthority("ADMIN")
                        ...
                        .loginPage("/login").defaultSuccessUrl("/") // passamos como parâmetro a URL para acesso à página de login que criamos
